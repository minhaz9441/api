...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>M</b>OT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Minhaj</b>Trade</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            @if(!empty(auth()->user()->profile->thumbnail))
                    <img src="{{ asset('storage/'.auth()->user()->profile->thumbnail) }}" alt="User Image" class="user-image">
                    @else
                    <img src="{{ asset('assets/admin/img/img_avatar.png')}}" class="user-image" alt="User Image">
                    @endif
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                    @if(!empty(auth()->user()->profile->thumbnail))
                    <img src="{{ asset('storage/'.auth()->user()->profile->thumbnail) }}" alt="User Image" class="img-circle">
                    @else
                    <img src="{{ asset('assets/admin/img/img_avatar.png')}}" class="img-circle" alt="User Image">
                    @endif
                <p>
                  {{ auth()->user()->name }}
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.clients.index') }}"><i class="fa fa-circle-o"></i> All Clients</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Add Client</a></li>
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Trashed Clients</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Trashed Categories</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Add Product</a></li>
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Trashed Products</a></li>
          </ul>
        </li>
      </ul>
    </section>
