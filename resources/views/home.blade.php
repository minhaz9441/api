...
<div class="row">
	<div class="col-md-3">
		<div href="#" class="card card-product-grid">
			<a href="#" class="img-wrap"> <img src="{{ asset('images/items/1.jpg')}}"> </a>
	...
	<div class="col-md-3">
		<div href="#" class="card card-product-grid">
			<a href="#" class="img-wrap"> <img src="{{ asset('images/items/2.jpg')}}"> </a>
			<figcaption class="info-wrap">
	...
	<div class="col-md-3">
		<div href="#" class="card card-product-grid">
			<a href="#" class="img-wrap"> <img src="{{ asset('images/items/3.jpg')}}"> </a>
			<figcaption class="info-wrap">
	...
	<div class="col-md-3">
		<div href="#" class="card card-product-grid">
			<a href="#" class="img-wrap"> <img src="{{ asset('images/items/4.jpg')}}"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Just another product name</a>
...
<div class="row">
	<div class="col-md-3">
		<div href="#" class="card card-product-grid">
			<a href="#" class="img-wrap"> <img src="{{ asset('images/items/5.jpg')}}"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Just another product name</a>
	...
	<div class="col-md-3">
		<div href="#" class="card card-product-grid">
			<a href="#" class="img-wrap"> <img src="{{ asset('images/items/6.jpg')}}"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Some item name here</a>
	...
	<div class="col-md-3">
		<div href="#" class="card card-product-grid">
			<a href="#" class="img-wrap"> <img src="{{ asset('images/items/7.jpg')}}"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Great product name here</a>
	...
	<div class="col-md-3">
		<div href="#" class="card card-product-grid">
			<a href="#" class="img-wrap"> <img src="{{ asset('images/items/9.jpg')}}"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Just another product name</a>
...
<a href="#"><img src="{{ asset('images/misc/appstore.png')}}" height="40"></a>
<a href="#"><img src="{{ asset('images/misc/appstore.png')}}" height="40"></a>
